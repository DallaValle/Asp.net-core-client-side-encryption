    ...
    public partial class first : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ciphertextId = table.Column<int>(nullable: false)
                    ...
                    iter = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ciphertexts", x => x.ciphertextId);
                    table.ForeignKey(
                        name: "FK_ciphertexts_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ciphertexts_ApplicationUserId",
                table: "ciphertexts",
